<template>
  <div>
    ...
    <div v-swiper:mySwiper="swiperOption">
      ...
      <div class="swiper-button-prev swiper-button-white" slot="button-prev"></div>//上一页
      <div class="swiper-button-next swiper-button-white" slot="button-next"></div>//下一页
    </div>
    <!-- 幻灯片 结束 -->
