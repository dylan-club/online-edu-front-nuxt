            ...
            <div class="i-box">
              ...
              <article class="ml10 mr10 pt20">
                <div>
                  ...
                  <div class="course-txt-body-wrap" v-html="courseWebVo.description">
                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterList" :key="chapter.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                <a :href="'/player/'+video.videoSourceId" :title="video.title" target="_blank" v-if="isBuy || Number(courseWebVo.price) == 0">
                                  <span class="fr">
                                ...
                                <a href="javascript: void(0);" @click="createOrder()" v-else>
                                  <span class="fr">
                                    <i class="free-icon vam mr10">立即购买</i>
                                  </span>
                                  <em class="lh-menu-i-2 icon16 mr5">&nbsp;</em>{{video.title}}
                                </a>
                              </li>
...
export default {
  ...
  methods: {
    ...
    initComment() {
      commentApi.getCommentList(this.courseId, this.page, this.limit)
        .then(response => {
    ...
    gotoPage(page) {
      commentApi.getCommentList(this.courseId, page, this.limit)
        .then(response => {
          this.data = response.data.data
        })
    },
